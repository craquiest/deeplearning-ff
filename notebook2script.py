...
def notebook2scriptSingle(fname):
    "Finds cells starting with `#export` and puts them into a new module"
    fname = Path(fname)
    fname_out = f'lg_{fname.stem.split("_")[0]}.py'
...
#################################################
# file to edit: deeplearning-ff/{fname.name}

'''
    for cell in code_cells: module += ''.join(cell['source'][1:]) + '\n\n'
    # remove trailing spaces
    module = re.sub(r' +$', '', module, flags=re.MULTILINE)
    if not (fname.parent/'exports').exists(): (fname.parent/'exports').mkdir()
    output_path = fname.parent/'exports'/fname_out
